                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Barcode Number</label>
                                                <input  type="tel" class="form-control"  maxlength="11"  name="barcodes" id="exampleFormControlInput1" placeholder="Enter Barcode Number" required>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" name="add_product"class="btn btn-primary" id="submit-btn" name="submit">Submit</button>
                                    </div>
                                    </form>
                                  </div>
                                </div>
